...
export const Select = styled('select', {
  ...
  'bc': 'transparent',
  'backgroundImage':
    'url(\'data:image/svg+xml;utf-8,<svg width="10" height="10" viewBox="0 0 16 12" xmlns="http://www.w3.org/2000/svg"><path stroke-width="2" d="M11.3613 2.73633L11.8887 3.26367L6 9.15234L0.111328 3.26367L0.638672 2.73633L6 8.09766L11.3613 2.73633Z"></path></svg>\')',
  '&:hover': {
    bc: '$flatHover',
  },
  '&:focus': {
